...
<style type="text/css">
        ...
        #emma-form-elements input[type="text"] { border: 2px solid; color: #565656; width: 98%; padding: 4px; }
...
<?php
    ...
    $this->table->add_row(array(
        '<label>Name</label>','<input type="text" name="name" id="name" style="color: #565656; width: 95%; padding: 4px;" />'));
    $this->table->add_row(array('<label>Email*</label>','<input type="email" name="email" id="email" required="true" style="color: #565656; width: 95%; padding: 4px;" />'));
